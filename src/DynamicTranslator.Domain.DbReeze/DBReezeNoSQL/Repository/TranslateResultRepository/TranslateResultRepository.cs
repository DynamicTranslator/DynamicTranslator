...
namespace DynamicTranslator.Domain.DbReeze.DBReezeNoSQL.Repository.TranslateResultRepository
{
    public class TranslateResultRepository : DBReezeRepositoryBase<CompositeTranslateResult, string>, ITranslateResultRepository
    {
        ...
        {
            CompositeTranslateResult translateResult = FirstOrDefault(result.Id);
        ...
        {
            CompositeTranslateResult translateResult = await FirstOrDefaultAsync(result.Id);
