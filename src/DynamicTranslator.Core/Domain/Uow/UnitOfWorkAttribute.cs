namespace DynamicTranslator.Core.Domain.Uow
{
    ...
    ///     At the end of method call, transaction is commited and all changes applied to the database if there is no
    ///     exception,
    ///     othervise it's rolled back.
    /// </summary>
    /// <remarks>
    ///     This attribute has no effect if there is already a unit of work before calling this method, if so, it uses the same
    ///     transaction.
    /// </remarks>
